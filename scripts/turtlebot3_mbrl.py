...
if __name__ == '__main__':
    ...
    """Parameters"""
    n_iter=  5 #number of (dagger) iterations
    ...
    action_sequence = agent.actor.sample_action_sequences(num_sequences=1, horizon=10) #20 reacher
    ...
    for i in range(agent.dyn_models[0].ob_dim):
        ...
        plt.plot(true_states['observations'][i], 'g')
